...
LD_plot <- function(panel,chr){
    ...
    bins = seq(1,1000000,by=1000) #1000 bins of 1000 because it is a diversity pop
    ...
    Halfdecay <- 672977.2 # for some reason the cluster have a hard time spitting out fity and fitx if submitted as a sbatch job. You can get this value using interactive nodes though
    ...
    p4=ggplot(LD.averages) +
      ...
      scale_y_continuous(limits = c(0.0,0.25),n.breaks=8) +
